            ...
            if (marker.address) {
                ...
                var dragEndFunction = function (m) {
                	...
                	return function(latlng) {
                		alert("m: " + m);
                    	alert('parentMarker.stateHiddenFieldID: ' + m.stateHiddenFieldID);
                    	alert('parentMarker.markerID: ' + m.markerID);        	
                ...
                GEvent.addListener(themarker, 'dragend', dragEndFunction(themarker) );
            }
        };
